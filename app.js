...
function setEntrataUnit(unit){_entrataUnit=unit;document.getElementById('ent-toggle-cartoni').style.background=unit==='cartoni'?'var(--accent)':'transparent';document.getElementById('ent-toggle-cartoni').style.color=unit==='cartoni'?'#000':'#c0c0c0';document.getElementById('ent-toggle-pezzi').style.background=unit==='pezzi'?'var(--accent)':'transparent';document.getElementById('ent-toggle-pezzi').style.color=unit==='pezzi'?'#000':'#c0c0c0';document.getElementById('man-qty-label').textContent=unit==='cartoni'?'Quantità (cartoni)':'Quantità (pezzi)';var sfusiRow=document.getElementById('man-sfusi-row');if(sfusiRow)sfusiRow.style.display=unit==='cartoni'?'block':'none';}
function setUscitaUnit(unit){_uscitaUnit=unit;document.getElementById('usc-toggle-cartoni').style.background=unit==='cartoni'?'var(--accent)':'transparent';document.getElementById('usc-toggle-cartoni').style.color=unit==='cartoni'?'#000':'#c0c0c0';document.getElementById('usc-toggle-pezzi').style.background=unit==='pezzi'?'var(--accent)':'transparent';document.getElementById('usc-toggle-pezzi').style.color=unit==='pezzi'?'#000':'#c0c0c0';document.getElementById('man-usc-qty-label').textContent=unit==='cartoni'?'Quantità (cartoni)':'Quantità (pezzi)';}
...
function closeModal(){document.getElementById('modal-overlay').classList.remove('active');document.getElementById('modal-overlay').dataset.editId='';['new-code','new-desc','new-qty','new-min','new-fornitore','new-cliente','new-preordine','new-corsia','new-pezzi-sfusi'].forEach(id=>{var el=document.getElementById(id);if(el)el.value='';});_corsiaPhotoData=null;var preview=document.getElementById('corsia-photo-preview');if(preview)preview.style.display='none';}
